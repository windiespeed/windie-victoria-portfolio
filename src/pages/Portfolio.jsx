...
export default function Portfolio() {
  ...
  return (
    <div className="container py-5">
      ...
      {activeTab === "UX/UI" && (
        <div className="figma-embed my-5 text-center">
          <iframe
            style={{ border: 'none', width: '100%', maxWidth: '900px', height: '500px' }}
            src="https://embed.figma.com/proto/YECKxuTSE7mV7yZblbYwMw/Windie-Speed---UI-UX-Photo-App?node-id=9818-3975&p=f&scaling=scale-down&content-scaling=fixed&page-id=6301%3A57&starting-point-node-id=9818%3A3975&embed-host=share" allowfullscreen
            title="Figma UX/UI Embed"
          ></iframe>
        </div>
      )}
